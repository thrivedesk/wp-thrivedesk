...
jQuery(document).ready(function ($) {
  ...
  // get search input id
  var tdTicketSearchId = $('#td-ticket-search');
  ...
  tdTicketSearchId.on('search', function (e) {
    var tableContainer = $('#conversation-table');
    var search = $(this).val();
    tableContainer.find('tr').each(function (index, element) {
      ...
      var row = $(element);
      var ticketId = row === null || row === void 0 || (_row$text = row.text()) === null || _row$text === void 0 ? void 0 : _row$text.toLowerCase();
  ...
  function search_query() {
    var search_query = $('#td-search-input').val();
    var tdSearchSpinner = $('#td-search-spinner');
    var list = $('#td-search-results');
    var kbRequest;
    var wpRequest;
    ...
    Promise.all([kbRequest, wpRequest]).then(function (results) {
      ...
      if (kbData.length > 0) {
        kbData.forEach(function (item, i) {
          kbResultsHtml += "<li class=\"td-search-item\" id=\"td-search-item-".concat(i, "\">\n                            <a target=\"_blank\" href=\"").concat(item.links.self, "\">\n                                <div class=\"td-search-content\">\n                                    <span class=\"td-search-tag\">").concat(item.categories.join(', '), "</span>\n                                    <span class=\"td-search-title\">").concat(item.title, "</span>\n                                    <span class=\"td-search-excerpt\">").concat(item.excerpt, "</span>\n                                </div>\n                            </a>\n                        </li>");
        });
      } else {
        var new_ticket_url = $('#td-new-ticket-url').attr('href');
        kbResultsHtml += "<li class=\"h-36 flex items-center justify-center text-slate-500\">\n                        <div>No article found on our knowledge base. <a href=\"".concat(new_ticket_url, "\" target=\"_blank\" class=\"text-blue-600\">Click here </a>to open a new ticket</div>\n                    </li>");
      }

      // Process WP search results
      var wpResultsHtml = '';
      if (_typeof(wpData) == 'object' && wpData.data.length > 0) {
        wpData.data.forEach(function (item, i) {
          wpResultsHtml += "<li class=\"td-search-item\" id=\"td-search-item-".concat(i, "\">\n                            <a target=\"_blank\" href=\"").concat(item.link, "\">\n                                <div class=\"td-search-content\">\n                                    <span class=\"td-search-tag\">").concat(item.categories, "</span>\n                                    <span class=\"td-search-title\">").concat(item.title, "</span>\n                                    <span class=\"td-search-excerpt\">").concat(item.excerpt, "</span>\n                                </div>\n                            </a>\n                        </li>");
        });
      } else {
        var _new_ticket_url = $('#td-new-ticket-url').attr('href');
        wpResultsHtml += "<li class=\"h-36 flex items-center justify-center text-slate-500\">\n                        <div>No article found. <a href=\"".concat(_new_ticket_url, "\" target=\"_blank\" class=\"text-blue-600\">Click here </a>to open a new ticket</div>\n                    </li>");
      }
      var combinedResults = "\n                    <div class=\"px-4\">\n                        <p class=\"px-2 font-bold\">Search results from Knowledge Base</p>\n                    </div>\n                    <ul>".concat(kbResultsHtml, "</ul>\n                    <div class=\"px-4\">\n                        <p class=\"px-2 font-bold\">Search results from WordPress</p>\n                    </div>\n                    <ul>").concat(wpResultsHtml, "</ul>\n                ");
  ...
  $('#td_conversation_reply').submit(function (e) {
    e.preventDefault();
    var td_reply_none = $("#td_reply_none").val();
    var td_conversation_id = $("#td_conversation_id").val();
    var reply_text = $("#td_conversation_editor").val();
    if (reply_text === '') {
      ...
      jQuery.post(td_objects.ajax_url, {
