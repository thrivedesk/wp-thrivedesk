...
jQuery(document).ready(function ($) {
  ...
  tdTicketSearchId.on('search', function (e) {
    ...
    tableContainer.find('tr').each(function (index, element) {
      ...
      var row = $(element);
      var ticketId = row === null || row === void 0 ? void 0 : (_row$text = row.text()) === null || _row$text === void 0 ? void 0 : _row$text.toLowerCase();
