...
jQuery(document).ready(function ($) {
  ...
  $('#td_helpdesk_form').submit(function (e) {
    ...
    var td_helpdesk_post_sync = $('.td_helpdesk_post_sync:checked').map(function (i, item) {
      return item.value;
    }).get();
    var td_user_account_pages = $('.td_user_account_pages:checked').map(function (i, item) {
      return item.value;
    }).get();
    jQuery.post(thrivedesk.ajax_url, {
  ...
  var $element = $('#td_helpdesk_api_key')[0].innerHTML;
        ...
        while (1) switch (_context.prev = _context.next) {
          ...
          case 6:
            jQuery.post(thrivedesk.ajax_url, {
              ...
              if ((parsedResponse === null || parsedResponse === void 0 ? void 0 : parsedResponse.code) === 422) {
                sweetalert2__WEBPACK_IMPORTED_MODULE_0___default().fire({
                  icon: 'error',
                  title: 'Error',
              ...
              if ((data === null || data === void 0 ? void 0 : data.message) === 'Unauthenticated.') {
                sweetalert2__WEBPACK_IMPORTED_MODULE_0___default().fire({
                  icon: 'error',
                  title: 'Error',
                  text: 'Invalid API Key'
                });
              } else if ((data === null || data === void 0 ? void 0 : data.message) === 'Server Error') {
                sweetalert2__WEBPACK_IMPORTED_MODULE_0___default().fire({
                  icon: 'error',
                  title: 'Error',
                  text: 'Server Error'
          ...
          case 0:
            jQuery.post(thrivedesk.ajax_url, {
              ...
              if ((data === null || data === void 0 ? void 0 : data.message) === 'Unauthenticated.') {
                ...
                assistantList.html('');
                if ((data === null || data === void 0 ? void 0 : (_data$assistants = data.assistants) === null || _data$assistants === void 0 ? void 0 : _data$assistants.length) > 0) {
                  ...
                  assistantList.append('<option value="">No Assistant Found</option>');
          ...
          case 0:
            ...
            jQuery.post(thrivedesk.ajax_url, {
              ...
              if (data.status == 'success') {
                var parsedResponse = JSON.parse(response);
                var _data = parsedResponse === null || parsedResponse === void 0 ? void 0 : parsedResponse.data;
                if (_data === true) {
                  $('#api_key_alert').addClass('hidden');
  ...
  $('#thrivedesk_clear_cache_btn').on('click', function (e) {
    jQuery.get(thrivedesk.ajax_url, {
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkthrivedesk"] = self["webpackChunkthrivedesk"] || [];
...
/******/ 	__webpack_require__.O(undefined, ["css/thrivedesk","css/admin"], () => (__webpack_require__("./resources/js/admin.js")))
/******/ 	__webpack_require__.O(undefined, ["css/thrivedesk","css/admin"], () => (__webpack_require__("./resources/css/admin.css")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["css/thrivedesk","css/admin"], () => (__webpack_require__("./resources/css/thrivedesk.css")))
