<div class="hidden tab-resource h-full">
    <h1 class="text-5xl font-bold mr-32"><?php _e('Here are some helpful resources to get you started', 'thrivedesk');?></h1>
    <ul class="nav-tabs mt-3 mr-32 inner-tab-link">
        <li>
            <a data-target="tab-resource-plugins" class="active" href="#resource-plugins"><?php _e('Plugins', 'thrivedesk');
            ?></a>
        </li>
        <li>
            <a data-target="tab-resource-themes" href="#resource-themes"><?php _e('Themes', 'thrivedesk');?></a>
        </li>
        <li>
            <a data-target="tab-resource-services" href="#resource-services"><?php _e('Services', 'thrivedesk');?></a>
        </li>
    </ul>
