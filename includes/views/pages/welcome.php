...
<div class="thrivedesk">
	...
	<div class="flex items-center justify-center h-full">
		...
		<div class="flex items-center space-x-2">
			<a href="<?php echo esc_url( \ThriveDesk\Admin::connect_url( '/auth/register' ) ); ?>" class="btn btn-primary w-full space-x-2 text-white!">
			...
			<a href="<?php echo esc_url( \ThriveDesk\Admin::connect_url( '/auth/authorize' ) ); ?>" class="btn btn-secondary w-full space-x-2">
