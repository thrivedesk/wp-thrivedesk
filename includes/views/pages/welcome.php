<div class="flex flex-col h-screen relative p-10">
	...
	<div class="max-w-lg space-y-4">
		<img src="<?php echo esc_url( THRIVEDESK_PLUGIN_ASSETS . '/images/td-icon.svg' ); ?>" alt="ThriveDesk logo" class="w-20">
		<div class="text-3xl font-bold"><?php esc_html_e( "Welcome, Let's Setup Your HelpDesk", 'thrivedesk' ); ?></div>
		<div class="text-lg text-gray-500">
		<?php esc_html_e( 'You are few clicks away from adding helpdesk and live chat to your website. ThriveDesk is a complete helpdesk solution that works with WordPress without any database queries or maintenance hassle.', 'thrivedesk' ); ?>
		</div>

		<div class="flex items-center space-x-2">
		<a href="<?php echo esc_url( THRIVEDESK_APP_URL . '/auth/register?auth_return_url=' . urlencode( get_bloginfo( 'url' ) . '/wp-admin/admin.php?page=thrivedesk&auth_platform=WordPress' ) ); ?>" class="btn btn-primary">
		...
		<a href="<?php echo esc_url( THRIVEDESK_APP_URL . '/auth/authorize?auth_return_url=' . urlencode( get_bloginfo( 'url' ) . '/wp-admin/admin.php?page=thrivedesk&auth_platform=WordPress' ) ); ?>" class="btn btn-secondary">
		...
		<div class="text-gray-500 text-[12px]">Already have API key? <a href="<?php echo esc_url( admin_url( 'admin.php?page=td-api' ) ); ?>" class="underline">Add here</a></div>
