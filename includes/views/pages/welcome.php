  ...
  <div class="flex items-center justify-center h-full">
    <div class="max-w-lg space-y-4">
      ...
      <div class="flex items-center space-x-2">
        <a href="<?php echo THRIVEDESK_APP_URL . '/register?store=' . get_bloginfo('url') . '/wp-admin/admin.php?page=thrivedesk' . "&platform=WordPress"?>" target="_blank" class="btn-primary">
        ...
        <a href="<?php echo THRIVEDESK_APP_URL . '/handshake?store=' . get_bloginfo('url') . '/wp-admin/admin.php?page=thrivedesk' . "&platform=WordPress" ?>" class="btn-secondary">
