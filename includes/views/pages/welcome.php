  ...
  <div class="flex items-center justify-center h-full">
    <div class="max-w-lg space-y-4">
      ...
      <div class="flex items-center space-x-2">
        <a href="<?php echo THRIVEDESK_APP_URL . '/register?store=' . get_bloginfo('url') . '/wp-admin/admin.php?page=thrivedesk'?>" target="_blank" class="btn btn-primary">
        ...
        <a href="<?php echo THRIVEDESK_APP_URL . '/handshake?store=' . get_bloginfo('url') . '/wp-admin/admin.php?page=thrivedesk' ?>" class="btn btn-secondary">
