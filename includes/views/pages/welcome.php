  ...
  <div class="flex items-center justify-center h-full">
    <div class="max-w-lg space-y-4">
      ...
      <div class="flex items-center space-x-2">
        <a href="<?php echo esc_url(THRIVEDESK_APP_URL . '/auth/register?auth_return_url=' . get_bloginfo('url') . '/wp-admin/admin.php?page=thrivedesk&auth_platform=WordPress');?>" class="btn btn-primary">
        ...
        <a href="<?php echo esc_url(THRIVEDESK_APP_URL . '/auth/authorize?auth_return_url=' . get_bloginfo('url') . '/wp-admin/admin.php?page=thrivedesk&auth_platform=WordPress'); ?>" class="btn btn-secondary">
