<div class="flex flex-col h-screen relative p-10">
  ...
  <div class="flex items-center justify-center h-full">
    <div class="max-w-lg space-y-4">
      <img src="<?php echo THRIVEDESK_PLUGIN_ASSETS . '/images/td-icon.svg' ?>" alt="ThriveDesk logo" class="w-20">
      <div class="text-3xl font-bold"><?php esc_html_e( "Welcome, Let's Setup Your HelpDesk", 'wp-thrivedesk' ); ?></div>
      <div class="text-lg text-gray-500">
        <?php esc_html_e( 'You are few clicks away from adding helpdesk and live chat to your website. ThriveDesk is a complete helpdesk solution that works with WordPress without any database queries or maintenance hassle.', 'wp-thrivedesk' ); ?>
      </div>

      <div class="flex items-center space-x-2">
        <a href="<?php echo THRIVEDESK_APP_URL . '/register?authReturnUrl=' . get_bloginfo('url') . '/wp-admin/admin.php?page=thrivedesk&authPlatform=WordPress'?>" class="btn btn-primary">
        ...
        <a href="<?php echo THRIVEDESK_APP_URL . '/auth/authorize?authReturnUrl=' . get_bloginfo('url') . '/wp-admin/admin.php?page=thrivedesk&authPlatform=WordPress' ?>" class="btn btn-secondary">
