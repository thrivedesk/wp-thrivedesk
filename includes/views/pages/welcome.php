...
<div class="thrivedesk">
	...
	<div class="flex items-center justify-center h-full">
		...
		<div class="flex items-center space-x-2">
			<a href="<?php echo esc_url( THRIVEDESK_APP_URL . '/auth/register?auth_return_url=' . get_bloginfo( 'url' ) . '/wp-admin/admin.php?page=thrivedesk&auth_platform=WordPress' ); ?>" class="btn btn-primary w-full space-x-2 text-white!">
			...
			<a href="<?php echo esc_url( THRIVEDESK_APP_URL . '/auth/authorize?auth_return_url=' . get_bloginfo( 'url' ) . '/wp-admin/admin.php?page=thrivedesk&auth_platform=WordPress' ); ?>" class="btn btn-secondary w-full space-x-2">
