  ...
  <div class="flex items-center justify-center h-full">
    <div class="max-w-lg space-y-4">
      ...
      <div class="flex items-center space-x-2">
        <a href="<?php echo THRIVEDESK_APP_URL . '/register?auth_return_url=' . get_bloginfo('url') . '/wp-admin/admin.php?page=thrivedesk&auth_platform=WordPress'?>" class="btn btn-primary">
