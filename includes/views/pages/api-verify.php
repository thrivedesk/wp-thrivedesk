<div class="flex flex-col h-screen relative p-10">
	...
	<div class="w-2/4 2xl:w-1/3 space-y-4">
		...
		<div class="text-2xl font-bold"><?php esc_html_e( 'Just one last step!', 'thrivedesk' ); ?></div>
		...
		<input type="password" id="td_helpdesk_api_key" class="w-full p-2 border border-gray-300 shadow-sm rounded" placeholder="Enter your API Key" value="<?php echo isset( $_GET['token'] ) ? esc_attr( sanitize_text_field( wp_unslash( $_GET['token'] ) ) ) : ''; ?>"/>
