  ...
  <div class="flex flex-col min-h-screen relative p-10">
    ...
    <div class="flex flex-1 items-center justify-center py-10">
      <div class="w-full max-w-lg space-y-4">
        ...
        <div class="td-card p-6! space-y-5">
        ...
        <div class="td-card p-5! space-y-3">
          <div class="flex items-start gap-2">
            <span class="text-blue-600 shrink-0 mt-px"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="18" height="18" fill="none" aria-hidden="true"><circle cx="12" cy="12" r="9.25" stroke="currentColor" stroke-width="1.5"/><path d="M12 16.5v-5M12 8h.01" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/></svg></span>
            <div>
              <div class="text-sm font-semibold text-slate-700"><?php esc_html_e( 'Allowlist our IP addresses', 'thrivedesk' ); ?></div>
              <p class="mt-1 m-0! text-gray-500"><?php esc_html_e( "For a seamless integration, add these IP addresses to your server's firewall or security plugin.", 'thrivedesk' ); ?></p>
            </div>
          </div>
          ...
          <ul class="m-0! p-0! list-none space-y-1.5">
            <?php foreach ( thrivedesk_service_ips() as $td_service_ip ) : ?>
              <li class="td-ip-row">
                ...
                >
                  <span class="td-copy-idle"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="16" height="16" fill="none" aria-hidden="true"><rect x="9" y="9" width="11" height="11" rx="2.5" stroke="currentColor" stroke-width="1.5"/><path d="M15 6V5.5A2.5 2.5 0 0 0 12.5 3h-6A2.5 2.5 0 0 0 4 5.5v6A2.5 2.5 0 0 0 6.5 14H7" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/></svg></span>
                  <span class="td-copy-done"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="16" height="16" fill="none" aria-hidden="true"><path d="m5 12.5 4.5 4.5L19 7" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg></span>
                </button>
              </li>
            <?php endforeach; ?>
          </ul>
