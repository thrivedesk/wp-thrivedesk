    ...
    <div class="flex items-center justify-center mt-48">
      <div class="w-2/4 2xl:w-1/3 space-y-4">
        ...
        <div class="td-card space-y-4">
          ...
          <input type="password" id="td_helpdesk_api_key" class="w-full p-2! border border-slate-300! shadow-sm rounded" placeholder="<?php esc_attr_e( 'Enter your API Key', 'thrivedesk' ); ?>" value="<?php echo esc_attr( \ThriveDesk\Admin::connect_return_token() ); ?>"/>
