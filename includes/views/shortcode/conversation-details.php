...
<div class="w-full bg-gray-200 py-6 px-8 td-shortcode-body" style="margin: 20px 0 20px 0;">
    <div class="py-4 px-2 flex flex-col justify-start">
        ...
        <p class="text-sm mt-2"><span>Last update: <?= \ThriveDesk\Conversations\Conversation::diffForHumans($conversation['updated_at']) ?></span></p>
        ...
        <div class="px-6 py-4">
                    ...
                    <div class="px-6 py-4 pt-3">
                        <div class="flex border-b">
                            <div class="flex-none w-14 h-14">
                                <img class="w-10 h-10 rounded-full" src="<?= $event['actor']['avatar'] ?? '' ?>" alt="<?= $event['actor']['name'] ?? '' ?>
                                        avatar" />
                            </div>
            ...
            <div class="py-6">
                <form action="" id="td_conversation_reply" method="POST">
                    ...
                    <div class="mb-6">
                        <button type="submit" id="td_conversation_reply_submit" data-nonce="<?php echo esc_attr($td_reply_nonce); ?>" class="text-white bg-blue-700
                                    hover:bg-blue-800
