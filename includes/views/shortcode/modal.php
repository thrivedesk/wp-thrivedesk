...
<div class="td-modal-container max-w-full h-screen w-screen" aria-modal="true" role="dialog">
	<div class="td-modal">
		...
		<div class="td-modal-header">
			<form class="">
				<label for="td-search-input" id="tdSearch-label"><?php thrivedesk_view( '/icons/search.svg' ); ?></label>
		...
		<div class="td-modal-footer">
			<a href="<?php echo esc_url( get_page_link( get_post( get_td_helpdesk_options( 'td_helpdesk_settings' )['td_helpdesk_page_id'] ) ) ); ?>" id="td-new-ticket-url" target="_blank" class="td-btn-primary">
