							...
							<div class="flex flex-col mt-3 space-y-3">
								...
								<select id="td_knowledgebase_slug" class="bg-white border rounded px-2 py-1 w-2/3">
									...
									<?php foreach ( $td_knowledgebase as $value ) : ?>
										<option value="<?php echo $value['slug']; ?>" <?php echo ( array_key_exists( 'td_knowledgebase_slug', $td_helpdesk_selected_option ) && $td_helpdesk_selected_option['td_knowledgebase_slug'] == $value['slug'] ) ? 'selected' : ''; ?>>
											<?php echo $value['name']; ?>
										</option>
									<?php endforeach; ?>
								</select>
