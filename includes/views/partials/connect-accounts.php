...
/*
 * The two ways to get a key: make an account, or authorize one you already
 * have. Shown wherever this site is not connected yet - the setup screen, the
 * first row of the Overview tab, and the empty Live Chat and Portal tabs - so
 * the offer reads the same in all four places.
 */
?>
