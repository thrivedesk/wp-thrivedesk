...
<div class="integrations td-card">
            <div class="text-lg font-bold"><?php esc_html_e( 'Integrations', 'thrivedesk' ); ?></div>
            ...
            <div class="td-card relative flex items-center">
                ...
                <div class="ml-auto">
                    ...
                    <?php else : ?>
                        <button data-plugin="<?php echo esc_attr( $plugin['namespace'] ); ?>"
                            ...
                            <span><?php esc_html_e( 'Connect', 'thrivedesk' ); ?></span>
                        </button>
                ...
                <?php if ( $plugin['connected'] ) : ?>
                    ...
                    <div class="absolute -top-3 left-0">
                        <div class="p-1.5 rounded-full bg-green-100 text-green-600 text-xs flex items-center space-x-1" title="<?php esc_attr_e( 'Connected', 'thrivedesk' ); ?>">
