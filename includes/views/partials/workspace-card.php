...
/*
 * The body of the Workspace card, on its own so it can be rendered twice: once
 * with the page, and again over AJAX the moment a key is accepted. That second
 * render is why this partial takes no arguments and computes what it needs -
 * Admin::ajax_workspace_card() has nothing to hand it.
 */

$td_connected  = thrivedesk_is_connected();
// summary() probes five endpoints when it has nothing cached. Asking it before
// there is a key to probe with buys five failures and a cache entry recording
// them, so the question is only put once the answer can be anything else.
...
<?php if ( ! $td_connected ) : ?>
	...
	<?php // Nothing to report yet, and saying so beats a grid of empty rows. ?>
	<p class="mt-0! mb-0! text-gray-500">
		<?php esc_html_e( 'Once this site is connected, your workspace, plan and API access show up here.', 'thrivedesk' ); ?>
	</p>
	<p class="mt-3! mb-0! text-gray-500">
		<?php esc_html_e( 'Add your API key in the card above to get started.', 'thrivedesk' ); ?>
	</p>
